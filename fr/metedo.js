saisie = prompt("Entrez le nom de la ville :");
url = 'https://api.openweathermap.org/data/2.5/weather?q=' + saisie + 		'&appid=eb3e55ca0093756f2541d5ad27c5021c&units=metric';
  ...
  requete.onload = function() {
        ...
        else if (condition === 'Sun') 
		{
			...
			document.getElementById("a").src="../IMAGES/soleil.jpg";
				...
				document.querySelector('#feel').innerHTML = tpr;
